...
bot = telebot.TeleBot('8035327921:AAH25N8TdvnI6pWAy5SABmnMk2_x7Us_lbo')

# Admin user IDs
admin_id = {"7438914699", "6240986259"}
...
def start_command(message):
    ...
    bot.reply_to(message, "𝗪𝗲𝗹𝗰𝗼𝗺𝗲 𝘁𝗼 *ALEX 💵 ™* 𝗯𝗼𝘁 !", reply_markup=markup, parse_mode='Markdown')
    bot.send_message(
        message.chat.id,
